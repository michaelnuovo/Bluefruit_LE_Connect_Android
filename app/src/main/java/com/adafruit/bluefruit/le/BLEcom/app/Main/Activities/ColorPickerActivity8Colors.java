...
public class ColorPickerActivity8Colors extends ColorPickerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewList.add(findViewById(R.id.rgbColorViewFive));
        viewList.add(findViewById(R.id.rgbColorViewSix));
        viewList.add(findViewById(R.id.rgbColorViewSeven));
        viewList.add(findViewById(R.id.rgbColorViewEight));
